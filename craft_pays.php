...
if (!isset($_SESSION['user_role'])) {
    ...
    exit();
} elseif (!in_array($_SESSION['user_role'], ['Recruit', 'Member', 'Officer', 'chef', 'Admin'])) {
...
$sql = "SELECT id, title, image, description, craft_type, prerequisites, creator, created_at FROM NG_Craft_Pays WHERE title LIKE '%$search%'";
...
// Fetch all available crafts for the dropdown
$sql_all_crafts = "SELECT id, title FROM NG_Craft_Pays";
$result_all_crafts = $conn->query($sql_all_crafts);

$all_crafts = [];
if ($result_all_crafts->num_rows > 0) {
    while($row = $result_all_crafts->fetch_assoc()) {
        $all_crafts[] = $row;
    }
}
...
<body>
    <div class="search-container">
        <form class="form-inline" method="get" action="craft_pays.php">
    ...
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <button class="btn btn-primary" data-toggle="modal" data-target="#addCraftModal">Ajouter un Craft</button>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="card" data-toggle="modal" data-target="#productModal<?php echo $craft['id']; ?>">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><strong>Créateur :</strong> <?php echo $craft['creator']; ?></p>
                        <p class="card-text"><strong>Date :</strong> <?php echo $craft['created_at']; ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
    ...
    <!-- Add Craft Modal -->
    <div class="modal fade" id="addCraftModal" tabindex="-1" aria-labelledby="addCraftModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="add_craft.php">
                    <div class="modal-header">
                        <h5 class="modal-title" id="addCraftModalLabel">Ajouter un Craft</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="craft_id">Sélectionner un Craft</label>
                            <select class="form-control" id="craft_id" name="craft_id">
                                <?php foreach ($all_crafts as $craft): ?>
                                    <option value="<?php echo $craft['id']; ?>"><?php echo $craft['title']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>Créateur :</strong> <?php echo $craft['creator']; ?></p>
                    <p><strong>Date :</strong> <?php echo $craft['created_at']; ?></p>
                </div>
                <div class="modal-footer">
                ...
                <form method="post" action="edit_craft.php">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="creator" name="creator" value="<?php echo $craft['creator']; ?>">
                        </div>
                        <div class="form-group">
                            <label for="created_at">Date</label>
                            <input type="date" class="form-control" id="created_at" name="created_at" value="<?php echo $craft['created_at']; ?>">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
